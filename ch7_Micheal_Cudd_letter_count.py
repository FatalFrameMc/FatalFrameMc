...
# letter pulled from what letter forced to lower case.
# what_letter = input().lower did not work properly.
def letter_search(what_letter):
   if what_letter is not what_letter.islower():
      return what_letter.lower()

# word/phrase search defined as lower case letters.
# how to do as 1 def. errors happen when put as one def.
def word1_search(first_word):
   if first_word is not first_word.islower():
      return first_word.lower()

def word2_search(second_word):
   if second_word is not second_word.islower():
      return second_word.lower()

def word3_search(third_word):
